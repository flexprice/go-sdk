...
------------- | ------------- | -------------
[**SecretsIntegrationsByProviderProviderGet**](IntegrationsAPI.md#SecretsIntegrationsByProviderProviderGet) | **Get** /secrets/integrations/by-provider/{provider} | Get integration details
[**SecretsIntegrationsCreateProviderPost**](IntegrationsAPI.md#SecretsIntegrationsCreateProviderPost) | **Post** /secrets/integrations/create/{provider} | Create or update an integration
...
## SecretsIntegrationsByProviderProviderGet

> DtoSecretResponse SecretsIntegrationsByProviderProviderGet(ctx, provider).Execute()
...
func main() {
	...
	resp, r, err := apiClient.IntegrationsAPI.SecretsIntegrationsByProviderProviderGet(context.Background(), provider).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IntegrationsAPI.SecretsIntegrationsByProviderProviderGet``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `SecretsIntegrationsByProviderProviderGet`: DtoSecretResponse
	fmt.Fprintf(os.Stdout, "Response from `IntegrationsAPI.SecretsIntegrationsByProviderProviderGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSecretsIntegrationsByProviderProviderGetRequest struct via the builder pattern
...
## SecretsIntegrationsCreateProviderPost

> DtoSecretResponse SecretsIntegrationsCreateProviderPost(ctx, provider).Request(request).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IntegrationsAPI.SecretsIntegrationsCreateProviderPost(context.Background(), provider).Request(request).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IntegrationsAPI.SecretsIntegrationsCreateProviderPost``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `SecretsIntegrationsCreateProviderPost`: DtoSecretResponse
	fmt.Fprintf(os.Stdout, "Response from `IntegrationsAPI.SecretsIntegrationsCreateProviderPost`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSecretsIntegrationsCreateProviderPostRequest struct via the builder pattern
