...
// checks if the InvoiceInvoiceLineItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceInvoiceLineItem{}
...
func (o InvoiceInvoiceLineItem) MarshalJSON() ([]byte, error) {
...
func (o InvoiceInvoiceLineItem) ToMap() (map[string]interface{}, error) {
...
type NullableInvoiceInvoiceLineItem struct {
	value *InvoiceInvoiceLineItem
	isSet bool
}

func (v NullableInvoiceInvoiceLineItem) Get() *InvoiceInvoiceLineItem {
	return v.value
}

func (v *NullableInvoiceInvoiceLineItem) Set(val *InvoiceInvoiceLineItem) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceInvoiceLineItem) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceInvoiceLineItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceInvoiceLineItem(val *InvoiceInvoiceLineItem) *NullableInvoiceInvoiceLineItem {
	return &NullableInvoiceInvoiceLineItem{value: val, isSet: true}
}

func (v NullableInvoiceInvoiceLineItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceInvoiceLineItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
