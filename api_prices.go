...
type PricesAPIPricesLookupLookupKeyGetRequest struct {
	ctx context.Context
	ApiService *PricesAPIService
	lookupKey string
}

func (r PricesAPIPricesLookupLookupKeyGetRequest) Execute() (*DtoPriceResponse, *http.Response, error) {
	return r.ApiService.PricesLookupLookupKeyGetExecute(r)
}

/*
PricesLookupLookupKeyGet Get price by lookup key

Get price by lookup key

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param lookupKey Lookup key
 @return PricesAPIPricesLookupLookupKeyGetRequest
*/
func (a *PricesAPIService) PricesLookupLookupKeyGet(ctx context.Context, lookupKey string) PricesAPIPricesLookupLookupKeyGetRequest {
	return PricesAPIPricesLookupLookupKeyGetRequest{
		ApiService: a,
		ctx: ctx,
		lookupKey: lookupKey,
...
// Execute executes the request
//  @return DtoPriceResponse
func (a *PricesAPIService) PricesLookupLookupKeyGetExecute(r PricesAPIPricesLookupLookupKeyGetRequest) (*DtoPriceResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PricesAPIService.PricesLookupLookupKeyGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/prices/lookup/{lookup_key}"
...
type PricesAPIPricesSearchPostRequest struct {
	ctx context.Context
	ApiService *PricesAPIService
	filter *TypesPriceFilter
}

// Filter with DSL support
func (r PricesAPIPricesSearchPostRequest) Filter(filter TypesPriceFilter) PricesAPIPricesSearchPostRequest {
	r.filter = &filter
	return r
}

func (r PricesAPIPricesSearchPostRequest) Execute() (*DtoListPricesResponse, *http.Response, error) {
	return r.ApiService.PricesSearchPostExecute(r)
}

/*
PricesSearchPost List prices by filter

List prices with filter

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PricesAPIPricesSearchPostRequest
*/
func (a *PricesAPIService) PricesSearchPost(ctx context.Context) PricesAPIPricesSearchPostRequest {
	return PricesAPIPricesSearchPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return DtoListPricesResponse
func (a *PricesAPIService) PricesSearchPostExecute(r PricesAPIPricesSearchPostRequest) (*DtoListPricesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PricesAPIService.PricesSearchPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
