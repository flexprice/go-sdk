...
// checks if the CouponApplicationCouponApplication type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CouponApplicationCouponApplication{}

// CouponApplicationCouponApplication struct for CouponApplicationCouponApplication
type CouponApplicationCouponApplication struct {
...
func NewCouponApplicationCouponApplication() *CouponApplicationCouponApplication {
	this := CouponApplicationCouponApplication{}
	return &this
}
...
func (o CouponApplicationCouponApplication) MarshalJSON() ([]byte, error) {
...
func (o CouponApplicationCouponApplication) ToMap() (map[string]interface{}, error) {
...
type NullableCouponApplicationCouponApplication struct {
	value *CouponApplicationCouponApplication
	isSet bool
}

func (v NullableCouponApplicationCouponApplication) Get() *CouponApplicationCouponApplication {
	return v.value
}

func (v *NullableCouponApplicationCouponApplication) Set(val *CouponApplicationCouponApplication) {
	v.value = val
	v.isSet = true
}

func (v NullableCouponApplicationCouponApplication) IsSet() bool {
	return v.isSet
}

func (v *NullableCouponApplicationCouponApplication) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCouponApplicationCouponApplication(val *CouponApplicationCouponApplication) *NullableCouponApplicationCouponApplication {
	return &NullableCouponApplicationCouponApplication{value: val, isSet: true}
}

func (v NullableCouponApplicationCouponApplication) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCouponApplicationCouponApplication) UnmarshalJSON(src []byte) error {
	v.isSet = true
