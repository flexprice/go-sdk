...
// GetMeterUsagePreviewInvoice - Get invoice preview using meter_usage data
// Preview invoice using the meter_usage table for usage data instead of feature_usage.
func (s *Invoices) GetMeterUsagePreviewInvoice(ctx context.Context, request types.GetPreviewInvoiceRequest, opts ...dtos.Option) (*dtos.GetMeterUsagePreviewInvoiceResponse, error) {
	o := dtos.Options{}
	supportedOptions := []string{
		dtos.SupportedOptionRetries,
		dtos.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/invoices/meter-usage-preview")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &dtos.GetMeterUsagePreviewInvoiceResponse{
		HTTPMeta: types.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
