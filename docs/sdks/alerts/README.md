...
func main() {
    ...
    res, err := s.Alerts.QueryAlertLog(ctx, types.AlertLogFilter{}, dtos.QueryAlertLogSecurity{
        Option1: &dtos.QueryAlertLogSecurityOption1{
...
| `security`                                                               | [dtos.QueryAlertLogSecurity](../../models/dtos/queryalertlogsecurity.md) | :heavy_check_mark:                                                       | The security requirements to use for the request.                        |
