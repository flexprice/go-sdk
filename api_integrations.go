...
type IntegrationsAPISecretsIntegrationsByProviderProviderGetRequest struct {
	ctx context.Context
	ApiService *IntegrationsAPIService
	provider string
}

func (r IntegrationsAPISecretsIntegrationsByProviderProviderGetRequest) Execute() (*DtoSecretResponse, *http.Response, error) {
	return r.ApiService.SecretsIntegrationsByProviderProviderGetExecute(r)
}

/*
SecretsIntegrationsByProviderProviderGet Get integration details

Get details of a specific integration

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param provider Integration provider
 @return IntegrationsAPISecretsIntegrationsByProviderProviderGetRequest
*/
func (a *IntegrationsAPIService) SecretsIntegrationsByProviderProviderGet(ctx context.Context, provider string) IntegrationsAPISecretsIntegrationsByProviderProviderGetRequest {
	return IntegrationsAPISecretsIntegrationsByProviderProviderGetRequest{
		ApiService: a,
		ctx: ctx,
		provider: provider,
...
func (a *IntegrationsAPIService) SecretsIntegrationsByProviderProviderGetExecute(r IntegrationsAPISecretsIntegrationsByProviderProviderGetRequest) (*DtoSecretResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsAPIService.SecretsIntegrationsByProviderProviderGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/secrets/integrations/by-provider/{provider}"
...
type IntegrationsAPISecretsIntegrationsCreateProviderPostRequest struct {
	ctx context.Context
	ApiService *IntegrationsAPIService
	provider string
...
func (r IntegrationsAPISecretsIntegrationsCreateProviderPostRequest) Request(request DtoCreateIntegrationRequest) IntegrationsAPISecretsIntegrationsCreateProviderPostRequest {
	r.request = &request
	return r
}

func (r IntegrationsAPISecretsIntegrationsCreateProviderPostRequest) Execute() (*DtoSecretResponse, *http.Response, error) {
	return r.ApiService.SecretsIntegrationsCreateProviderPostExecute(r)
}

/*
SecretsIntegrationsCreateProviderPost Create or update an integration

Create or update integration credentials

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param provider Integration provider
 @return IntegrationsAPISecretsIntegrationsCreateProviderPostRequest
*/
func (a *IntegrationsAPIService) SecretsIntegrationsCreateProviderPost(ctx context.Context, provider string) IntegrationsAPISecretsIntegrationsCreateProviderPostRequest {
	return IntegrationsAPISecretsIntegrationsCreateProviderPostRequest{
		ApiService: a,
		ctx: ctx,
		provider: provider,
...
// Execute executes the request
//  @return DtoSecretResponse
func (a *IntegrationsAPIService) SecretsIntegrationsCreateProviderPostExecute(r IntegrationsAPISecretsIntegrationsCreateProviderPostRequest) (*DtoSecretResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsAPIService.SecretsIntegrationsCreateProviderPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/secrets/integrations/create/{provider}"
	localVarPath = strings.Replace(localVarPath, "{"+"provider"+"}", url.PathEscape(parameterValueToString(r.provider, "provider")), -1)
